<section class="dark:bg-gray-800 dark:text-gray-100">
	<div class="container mx-auto flex flex-col p-6">
		<h2 class="py-4 text-center text-3xl font-bold">Temporibus elit</h2>
		<div class="divide-y divide-gray-700">
			<div class="mx-auto grid grid-cols-4 justify-center space-y-8 p-8 lg:space-y-0">
				<div class="col-span-full flex items-center justify-center lg:col-span-1">
					<svg
				...
				<div
					class="col-span-full flex max-w-3xl flex-col justify-center text-center lg:col-span-3 lg:text-left"
				>
					<span class="text-xs uppercase tracking-wider dark:text-violet-400">Step 1 - Nihil</span>
					<span class="text-xl font-bold md:text-2xl">Veritatis dolores</span>
					<span class="mt-4 dark:text-gray-300"
						>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam facilis, voluptates
						error alias dolorem praesentium sit soluta iure incidunt labore explicabo eaque, quia
						architecto veritatis dolores, enim cons equatur nihil ipsum.</span
					>
				</div>
			</div>
			<div class="mx-auto grid grid-cols-4 justify-center space-y-8 p-8 lg:space-y-0">
				...
				<div
					class="col-span-full flex max-w-3xl flex-col justify-center text-center lg:col-span-3 lg:text-left"
				>
					<span class="text-xs uppercase tracking-wider dark:text-violet-400"
						>Step 2 - Explicabo</span
					>
			...
			<div class="mx-auto grid grid-cols-4 justify-center space-y-8 p-8 lg:space-y-0">
				...
				<div
					class="col-span-full flex max-w-3xl flex-col justify-center text-center lg:col-span-3 lg:text-left"
				>
					<span class="text-xs uppercase tracking-wider dark:text-violet-400">Step 3 - Facilis</span
					>
					<span class="text-xl font-bold md:text-2xl">Dolorem praesentium</span>
					<span class="mt-4 dark:bg-gray-800 dark:text-gray-300"
						>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam facilis, voluptates
						error alias dolorem praesentium sit soluta iure incidunt labore explicabo eaque, quia
						architecto veritatis dolores, enim cons equatur nihil ipsum.</span
					>
			...
			<div class="mx-auto grid grid-cols-4 justify-center space-y-8 p-8 lg:space-y-0">
				...
				<div
					class="col-span-full flex max-w-3xl flex-col justify-center text-center lg:col-span-3 lg:text-left"
				>
					<span class="text-xs uppercase tracking-wider dark:text-violet-400">Step 4 - Aperiam</span
					>
