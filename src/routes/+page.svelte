<script>
	import { HeaderLanding, HeroLanding, StatsLanding, FeaturesLanding, GalleryLanding, AppLanding, StepsLanding, ReviewsLanding, TeamLanding, FooterLanding } from '../lib/widgets/';
</script>
